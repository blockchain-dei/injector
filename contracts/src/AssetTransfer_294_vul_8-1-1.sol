...
Terminated
    ...
    function Accept() public    {
        ...
        if ((((tx.origin == InstanceBuyer) && (State != StateType.NotionalAcceptance)) && (State != StateType.SellerAccepted)))
            {
                revert();
            }
        if ((msg.sender == InstanceBuyer))
            {
                if ((State == StateType.NotionalAcceptance))
                    ...
                    if ((State == StateType.SellerAccepted))
                        {
        ...
        else 
            {
                if ((State == StateType.NotionalAcceptance))
                    ...
                    if ((State == StateType.BuyerAccepted))
                        {
                            State = StateType.Accepted;
                        }
            }
